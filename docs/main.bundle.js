...
var CrowBalanceComponent = /** @class */ (function () {
                ...
                if (status == __WEBPACK_IMPORTED_MODULE_3__classes_web3_loading_status_enum__["a" /* Web3LoadingStatus */].complete) {
                    this.accountSubscription = this.service.account$.subscribe(function (acc) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    if (!(acc != undefined)) return [3 /*break*/, 2];
                                    _a = this;
    ...
    CrowBalanceComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_web3_service__["a" /* Web3Service */], __WEBPACK_IMPORTED_MODULE_2__services_communicate_service__["a" /* CommunicateService */]])
    ...
    ServicesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__web3_service__["a" /* Web3Service */],
...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Web3Service; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__ = __webpack_require__("./node_modules/rxjs/_esm5/BehaviorSubject.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__classes_web3_loading_status_enum__ = __webpack_require__("./src/app/classes/web3-loading-status.enum.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Web3Service = /** @class */ (function () {
    function Web3Service(utils, firebase) {
        var _this = this;
        this.utils = utils;
                ...
                this.web3js.eth.net.getId().then(function (id) {
                    ...
                    switch (id) {
                        case 3:
                            ...
                            _this.web3js.eth.getAccounts().then(function (accs) {
                                ...
                                if (accs[0]) {
                                    ...
                                    _this.web3Status.next(__WEBPACK_IMPORTED_MODULE_4__classes_web3_loading_status_enum__["a" /* Web3LoadingStatus */].complete);
                                }
                                else {
                                    _this.account.next(accs[0]);
                                    _this.web3Status.next(__WEBPACK_IMPORTED_MODULE_4__classes_web3_loading_status_enum__["a" /* Web3LoadingStatus */].noAccountsAvailable);
                                }
                        ...
                        default:
                            ...
                            _this.web3Status.next(__WEBPACK_IMPORTED_MODULE_4__classes_web3_loading_status_enum__["a" /* Web3LoadingStatus */].wrongNetwork);
                            return;
                    }
                });
            }
            catch (e) {
                this.web3Status.next(__WEBPACK_IMPORTED_MODULE_4__classes_web3_loading_status_enum__["a" /* Web3LoadingStatus */].error);
            }
        }
        else {
            // this.setProvider(new Web3.providers.HttpProvider('https://ropsten.infura.io/'));
            this.web3Status.next(__WEBPACK_IMPORTED_MODULE_4__classes_web3_loading_status_enum__["a" /* Web3LoadingStatus */].noMetaMask);
        }
    }
    ...
    Web3Service.prototype.checkAccountMetaMask = function () {
        ...
        this.web3js.eth.getAccounts().then(function (accs) {
            ...
            if (accs[0] !== _this.account.value) {
                ...
                if (accs[0] != undefined) {
                    if (_this.web3Status.value != __WEBPACK_IMPORTED_MODULE_4__classes_web3_loading_status_enum__["a" /* Web3LoadingStatus */].complete) {
                        _this.web3Status.next(__WEBPACK_IMPORTED_MODULE_4__classes_web3_loading_status_enum__["a" /* Web3LoadingStatus */].complete);
                    }
                }
                else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.web3js.eth.sendSignedTransaction('0x' + serializedTxHex.toString('hex'))
    ...
    Web3Service = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__utils__["a" /* Utils */], __WEBPACK_IMPORTED_MODULE_3__firebase_service__["a" /* FirebaseService */]])
    ], Web3Service);
    return Web3Service;
}());
...
var TerminalComponent = /** @class */ (function () {
    ...
    TerminalComponent.prototype.handleCommandAsync = function (arg) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var args, output, _a, balWei, crowWei, balEth, balCrow;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        arg = arg.trim();
                        ...
                        if (!args.length) return [3 /*break*/, 13];
                    ...
                    case 12:
                        ...
                        return [3 /*break*/, 13];
                    case 13: return [2 /*return*/, Promise.resolve(output)];
                }
            });
        });
    };
    ...
    TerminalComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_web3_service__["a" /* Web3Service */], __WEBPACK_IMPORTED_MODULE_4__services_utils__["a" /* Utils */], __WEBPACK_IMPORTED_MODULE_2__services_firebase_service__["a" /* FirebaseService */], __WEBPACK_IMPORTED_MODULE_3__services_communicate_service__["a" /* CommunicateService */]])
    ], TerminalComponent);
